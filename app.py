...
def atualizar_produto_com_formulario(produto, formulario):
    ...
    possui_variacao = (
        formulario.get("possui_variacao") == "sim"
    )
    ...
    if possui_variacao:
        entrada_variacoes = formulario.get(
            "variacoes",
            ""
        )
        ...
        if not variacoes:
            raise ValueError(
                "Informe pelo menos uma variação."
            )

        entrada_estoques = formulario.get(
            "estoques_variacoes",
            ""
        )
        ...
        for item in entrada_estoques.split(","):
            ...
            try:
                ...
                raise ValueError(
                    "A quantidade do estoque deve ser "
                    "um número inteiro."
                )
